...
public partial class CUENTAS
{
    ...
    public virtual ICollection<BL_LIQUIDACIONESDET> BL_LIQUIDACIONESDETCodCueAcrNavigation { get; set; } = new List<BL_LIQUIDACIONESDET>();

    public virtual ICollection<BL_LIQUIDACIONESDET> BL_LIQUIDACIONESDETCodCueDeuNavigation { get; set; } = new List<BL_LIQUIDACIONESDET>();

    public virtual TABLAS? CODTABNavigation { get; set; }
}
